...
static ERL_NIF_TERM ATOM_HARD;
static ERL_NIF_TERM ATOM_HEADER;
static ERL_NIF_TERM ATOM_HIGHEST;
static ERL_NIF_TERM ATOM_IGNORE_SUBMODULES;
static ERL_NIF_TERM ATOM_IGNORED;
static ERL_NIF_TERM ATOM_INDEX;
...
static ERL_NIF_TERM ATOM_MIXED;
...
static ERL_NIF_TERM ATOM_RECURSIVE;
...
static ERL_NIF_TERM ATOM_UNTRACKED;
...
inline void init_atoms(ErlNifEnv* env)
{
  ...
  ATOM_IGNORE_SUBMODULES = enif_make_atom(env, "ignore_submodules");
  ATOM_IGNORED           = enif_make_atom(env, "ignored");
  ATOM_INDEX             = enif_make_atom(env, "index");
  ...
  ATOM_RECURSIVE         = enif_make_atom(env, "recursive");
  ...
  ATOM_SUBMODULES        = enif_make_atom(env, "submodules");
  ...
  ATOM_TYPECHANGE        = enif_make_atom(env, "atom_typechange");
  ATOM_UNTRACKED         = enif_make_atom(env, "untracked");
  ATOM_UPDATE            = enif_make_atom(env, "update");
  ATOM_VERBOSE           = enif_make_atom(env, "verbose");
  ATOM_WORKTREE          = enif_make_atom(env, "worktree");
